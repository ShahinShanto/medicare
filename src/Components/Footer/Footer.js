                    ...
                    <div className="g-5 mb-2 ">
                        <div className="d-flex flex-column flex-lg-row g-5 border-bottom ">
                            ...
                            <div className="col-lg-3 col-12 px-3 text-white my-2">
                                ...
                                <Link to="/specialist" className="fw-light nav-link active p-2  text-white" aria-current="page" ><i className="fas fa-user-md"></i> Specialist</Link>
                                <Link to="/department" className="fw-light nav-link active p-2  text-white" aria-current="page" ><i className="far fa-building"></i> Departments</Link>
